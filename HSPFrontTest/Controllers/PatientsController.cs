...
namespace HSPFrontTest.Controllers
{
    public class PatientsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nom,Telephone,Adresse,CodePostal,Ville")] Patient patient)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nom,Telephone,Adresse,CodePostal,Ville")] Patient patient)
        {
            if (id != patient.Id)
            {
                return NotFound();
